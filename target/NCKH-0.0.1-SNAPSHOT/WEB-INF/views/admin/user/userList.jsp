...
<body class="no-skin">
	...
	<!-- menu -->
		...
		<div class="main-content">
			<form action="<c:url value='/admin/user/listActive'/>" id="formSubmit"
				method="get">
									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createUser" value="/admin/user/edit" />
												<a flag="info"
													class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
													data-toggle="tooltip" title='Create User'
													href='${createUser}'> <span> <i
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
										                    ...
										                    <td style=" width: 35%;">${item.roleCode}</td>
				...
				$
						.ajax({
							...
							success : function(result) {
								window.location.href = "${userListURL}&message=delete_success";
							},
							error : function(error) {
								window.location.href = "${userListURL}&message=error_system";
							}
						});
			}
		</script>
